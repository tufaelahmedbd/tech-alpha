  ...
  return (
    <div className="slide" style={{ backgroundImage: `url(${image.src})` }}>
      <div className="slide-texts container mx-auto flex flex-col items-start justify-center h-full gap-5 text-violet-50 ">
        <h1 className=" text-7xl  font-semibold uppercase  space-font w-3/5">
          {image.headline}
        </h1>
        <p className=" w-3/5">{image.body}</p>
        <Link className="slide-btn uppercase border-2 border-violet-50 h-12 w-72 hover:text-orange-50  duration-300 font-medium mt-5">
